...
int main(int argc, char *argv[]) {
    ...
    if (array_is_sorted(playlist,length)) {
        printf("La playlist esta ordenada\n");
    } else {
        printf("La playlist no esta ordenada\n");
    }

    /* check if it is odd-sorted and show message */
     if (array_is_odd_sorted(playlist,length)) {
        printf("La playlist esta ordenada imparmente\n");
    } else {
        printf("La playlist no esta ordenada imparmente\n");
    }
