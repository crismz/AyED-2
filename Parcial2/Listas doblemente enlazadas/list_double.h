#ifndef _LIST_DOUBLE_H
#define _LIST_DOUBLE_H
...
elem_list list_head_left (list l);
/*
    PRE: not list_is_empty(l)
    Return the firts element of the list l
*/

list list_tail_rigth(list l);
/*
    PRE: not list_is_empty(l)
    Delete the first element of the list l
*/

elem_list list_head_right (list l);
/*
    PRE: not list_is_empty(l)
    Return the firts element of the list l
*/

list list_tail_left(list l);
/*
    PRE: not list_is_empty(l)
    Delete the first element of the list l
*/
