...
char *string_clone(const char *str, size_t length) {
    // De esta forma clone esta en memoria estatica(stack)
    // Pero nuestro puntero output tiene que apuntar a memoria dinamica para que el usuario pueda usar esa memoria
    // char clone[length + 1]; <---- FORMA MALA
